...
- [短链接系统开发路线](docs/短链接系统开发路线.md)
- [访问统计与消息链路可靠性复盘](docs/访问统计与消息链路可靠性复盘.md)
- [短链接项目面试题与参考回答](docs/短链接项目面试题与参考回答.md)
- [统计接口联调说明](docs/api/统计接口联调.md)

## 面试说明

项目中的可靠性边界、缓存降级、消息幂等、Flyway 迁移和多租户权限均有对应测试或复盘文档。面试交流时以当前代码真实实现为准，不把规划中的生产增强方案描述成已完成能力。
